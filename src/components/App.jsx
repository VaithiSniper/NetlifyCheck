    ...
    <Router>
      <Switch>
        ...
        <Route exact path='/home'>
          <div
            className={
              !smallerThan1000 ? "bg_image_home" : "bg_image_home_mobile"
            }>
            <Header />
            <PageContent />
            <Foot />
        ...
        <Route exact path='/about'>
          <div
            className={
              !smallerThan1000 ? "bg_image_about" : "bg_image_about_mobile"
            }>
            <Header />
            <About />
          </div>
        ...
        <Route exact path='/team'>
          <div
            className={
              !smallerThan1000 ? "bg_image_team" : "bg_image_team_mobile"
            }>
            <Header />
            <Team />
          </div>
        ...
        <Route exact path='/events'>
          <div
            className={
              !smallerThan1000 ? "bg_image_events" : "bg_image_events_mobile"
            }>
            <Header />
            <Events />
          </div>
        ...
        <Route exact path='/contact'>
          <div
            className={
              !smallerThan1000 ? "bg_image_contact" : "bg_image_contact_mobile"
            }>
            <Header />
            <Contact />
          </div>
        ...
        {/* <Route exact path='/terms'>
          <div
            className={
              !smallerThan1000
                ? "bg_image_paymentterms"
                : "bg_image_payment_mobileterms"
            }>
            <TandC />
          </div>
        </Route> */}
