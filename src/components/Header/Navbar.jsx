...
function Header(){
  ...
  function navbarRetuner(){
    ...
    <Navbar.Brand className="justify-content-start"><a href="https://bit-bangalore.edu.in/" target="_blank" rel="noopener noreferrer"><img height="80px" width="80px" src="img/bitlogo.png" alt="bit-logo" style={{paddingLeft:"10%"}}></img></a></Navbar.Brand>
